...
router.get("/signin/facebook", passport.authenticate("facebook"), function(req, res, next) {
   var username = req.user.username;
   console.log(' username ',username);
   return next();
});

router.get("/signin/google", passport.authenticate("google",  { scope: ['profile']}), function(req, res, next) {
   var username = req.user.username;
   console.log(' username ',username);
   return next();
});
